export default function Modules() {
    return (
        <div>
            <button id="wd-module-collapse">Collapse All</button>
            <button id="wd-module-progress">View Progress</button>
            ...
            <ul id="wd-modules">
                ...
                <li className="wd-module">
                    <div className="wd-title">Week 1, Lecture 2 - Formatting User Intergaces with HTML</div>
                    <ul className="wd-lessons">
                        <li className="wd-lesson">
                            <span className="wd-title">LEARNING OBJECTIVES</span>
                            <ul className="wd-content">
