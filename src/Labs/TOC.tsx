...
export default function TOC() {
  ...
  return (
    <ul className="nav nav-pills">
      ...
      <li className="nav-item">
        <a id="wd-github-ui" className="nav-link" target="_blank" rel="noreferrer" href="https://github.com/KartikJondhalekar/-kanbas-react-web-app">GitHub UI</a>
      </li>
      <li className="nav-item">
      ...
      <li className="nav-item">
        <a id="wd-server-link" className="nav-link" target="_blank" rel="noreferrer" href="https://kanbas-node-server-app-bhff.onrender.com">Render Server</a>
      </li>
    </ul>
  );
}
